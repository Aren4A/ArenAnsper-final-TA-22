  ...
  return (
    <Router>
     ...
     <div className="bg-cover bg-center w-full" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <button onClick={() => changeLanguage('et')}><img src="../public/twemoji_flag-estonia.png" alt="EST Flag" /></button>
      <button onClick={() => changeLanguage('en')}><img src="../public/flagpack_gb-ukm.png" alt="UK Flag" /></button>
     </h3>
