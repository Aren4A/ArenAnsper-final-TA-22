  ...
  return (
    <Router>
     ...
     <div className="bg-cover bg-center w-full" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <button onClick={() => changeLanguage('et')}><img src="/src/flag-est.jpg" alt="EST Flag" /></button>
      <button onClick={() => changeLanguage('en')}><img src="/src/flag-uk.jpg" alt="UK Flag" /></button>
     </h3>
