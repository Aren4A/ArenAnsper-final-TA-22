...
function Extra() {
 ...
 <div className="bg-cover bg-center w-full" >
      ...
      <div className='flex flex-col'>
        <h1 className='flex lg:p-2 text-[#012579] px-3 leading-[45px] lg:leading-[90px]'>
