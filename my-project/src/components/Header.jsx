  ...
  return (
    <div className="bg-cover bg-center w-full" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <header className='flex justify-end p-5'>
        <a href="#visioon" className="text-amber-400 mr-7 text-3xl">Visioon</a>
        <a href="#hind" className="text-amber-400 mr-7 text-3xl">Hind</a>
        <a href="#kontakt" className="text-amber-400 mr-5 text-3xl">Kontakt</a>
      </header>
